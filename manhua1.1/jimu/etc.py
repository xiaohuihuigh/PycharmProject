...
data_path = os.path.join("/home/zyh/Data/manhua/chihe/")             #漫画存入的目录

manhua_url = "http://m.930mh.com/manhua/12824/" #漫画的主链接

main_url = 'http://m.930mh.com'                 #网站链接

#在序章中间加0
manhua_json_path="chihe.json"                    #漫画每一个章节的章节名字和链接组成的json文件
